...
public final class ArticleDao_Impl implements ArticleDao {
  ...
  public ArticleDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfArticle = new EntityInsertionAdapter<Article>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, Article value) {
        ...
        final String _tmp;
        _tmp = __converters.fromSourceToString(value.getSource());
        if (_tmp == null) {
          stmt.bindNull(6);
        } else {
  ...
  @Override
  public Object insertArticle(final Article article, final Continuation<? super Long> p1) {
  ...
  @Override
  public LiveData<List<Article>> getAllArticlesFromDb() {
      ...
      public List<Article> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _tmpSource = __converters.fromStringToSource(_tmp);
